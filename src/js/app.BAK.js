/*global document, $, Backbone, _, ReactDOM, localStorage, console*/
...
$(function () {
    ...
    Projects = Backbone.Model.extend({
        ...
        render: function () {
            ...
            ReactDOM.render(
                <ProjectEntry />,
                document.getElementById('current_projects')
            );

            ReactDOM.render(
                <ProjectEntry />,
                document.getElementById('past_projects')
            );
    ...
    // only start foundation script once
